...
public abstract class GdxTextureResource extends Texture {
	public static final com.badlogic.gdx.graphics.Texture NO_TEXTURE = new com.badlogic.gdx.graphics.Texture(new Pixmap(1, 1, Pixmap.Format.RGBA8888));
	private com.badlogic.gdx.graphics.Texture gdxTexture = NO_TEXTURE;
